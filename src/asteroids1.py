...
class Asteroid1(pygame.sprite.Sprite):
    def __init__(self, player: Player1):
        ...
        self.rect.x = screen_size[0] + random.randint(1, 5) * self.taille[1]
        self.rect.y = screen_size[1] / 100 * self.ordonne
    ...
    def take_damage(self, amount):                                             # Prend des dégâts
        if self.health - amount > amount:
            ...
            self.player.take_experience(self.xp)

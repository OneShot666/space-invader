...
screen = pygame.image.load(f'{filename_images}/ui/background1.png')
...
banniere = pygame.image.load(f'{filename_images}/ui/icon.png')
...
level_select_taille = level_select_rect[2:4]
